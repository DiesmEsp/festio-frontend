    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-16 pt-6 text-center sm:px-6 sm:pt-8 lg:px-8">
          ...
          <div className="flex w-full justify-center">
            <h1 className="max-w-4xl text-center text-4xl font-hero font-extrabold tracking-tight leading-tight text-slate-900 sm:text-5xl">
              Tu evento ideal,
      ...
      <section className="landing-section">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mx-auto max-w-2xl text-center mb-16">
            <h2 className="text-3xl font-hero font-extrabold tracking-tight text-slate-900 sm:text-4xl">
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="landing-card group">
              ...
              <div>
                <h3 className="landing-card-title">Cotización Instantánea</h3>
                <p className="landing-card-desc">Olvídate de esperar días por un presupuesto. Recibe opciones reales al instante.</p>
              </div>
            </div>
            ...
            <div className="landing-card group">
              ...
              <div>
                <h3 className="landing-card-title">Disponibilidad Real</h3>
                <p className="landing-card-desc">Bloqueamos el inventario temporalmente para garantizar tu reserva.</p>
              </div>
            </div>

            {/* Card 3: Pago Seguro */}
            <div className="landing-card group sm:col-span-2 lg:col-span-1">
              <span className="landing-card-icon">
                <Shield size={26} />
              </span>
              <div>
                <h3 className="landing-card-title">Pago 100% Seguro</h3>
                <p className="landing-card-desc">Transacciones verificadas y garantías de cumplimiento del servicio.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="landing-section">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="relative w-full overflow-hidden landing-marquee-mask">
      ...
      <section className="landing-section">
        ...
        <div className="dot-grid-top" />
        <div className="orb-center" />
        <div className="orb-right-purple" />
        <div className="orb-left-fuchsia" />
      ...
      <section className="landing-section">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-hero font-extrabold tracking-tight text-slate-900 mb-4">
              Ayúdanos a mejorar
            </h2>
          ...
          <div className="mx-auto max-w-3xl">
            <form className="feedback-form text-left">
              <div className="grid gap-6">
                <div>
                  <label className="feedback-label">Tu nombre</label>
                  <input type="text" className="feedback-input" placeholder="Ej. María Pérez" />
                </div>
                <div>
                  <label className="feedback-label">Tu comentario</label>
                  <textarea rows={4} className="feedback-input resize-none" placeholder="Me encantaría que la plataforma tuviera..."></textarea>
                </div>
